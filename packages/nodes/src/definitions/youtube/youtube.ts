...
export const youtubeNode: NodeDefinition = {
  ...
  operationOutputs: {
    ...
    getChannelStats: [
      ...
      { key: 'title', type: 'string', description: 'Channel title' },
      { key: 'description', type: 'string', description: 'Channel description' },
      { key: 'viewCount', type: 'string', description: 'Total channel views' },
      { key: 'subscriberCount', type: 'string', description: 'Subscriber count' },
      { key: 'videoCount', type: 'string', description: 'Number of videos' },
      { key: 'hiddenSubscriberCount', type: 'boolean', description: 'Whether subscriber count is hidden' },
      { key: 'stats', type: 'object', description: 'Raw statistics object (nested)' },
    ],
    getSubscribers: [
      { key: 'subscriberCount', type: 'string', description: 'Subscriber count' },
      { key: 'viewCount', type: 'string', description: 'Total view count' },
      { key: 'videoCount', type: 'string', description: 'Number of videos' },
      { key: 'hiddenSubscriberCount', type: 'boolean', description: 'Whether subscriber count is hidden' },
    ],
    createComment: [
    ...
    channel_stats: [
      { key: 'viewCount', type: 'string', description: 'Total channel view count' },
      { key: 'subscriberCount', type: 'string', description: 'Subscriber count' },
      { key: 'videoCount', type: 'string', description: 'Number of videos' },
      { key: 'hiddenSubscriberCount', type: 'boolean', description: 'Whether subscriber count is hidden' },
      { key: 'title', type: 'string', description: 'Channel title' },
