...
import { LogIn, Mail, Lock, ChevronRight, Bot, ArrowRight, Github } from 'lucide-react';
...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col items-center justify-center px-4 relative overflow-hidden font-inter">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="flex flex-col items-center mb-12">
          ...
          <h1 className="text-3xl font-extrabold tracking-tight text-foreground">Sign in to Hub</h1>
          <p className="text-muted font-medium mt-2">Continue your autonomous journey</p>
        </div>
        ...
        <div className="bg-card border border-border p-10 sm:p-12 rounded-[2.5rem] shadow-2xl relative overflow-hidden">
          ...
          <div className="relative my-10">
            ...
            <div className="relative flex justify-center text-xs font-bold uppercase tracking-wider">
              <span className="bg-card px-4 text-muted/50">Or continue with</span>
            </div>
          </div>
        ...
        <p className="text-center text-sm font-medium text-muted mt-10">
          First time here?{' '}
          <Link href="/signup" className="text-accent font-bold hover:underline transition-all inline-flex items-center gap-1 group">
