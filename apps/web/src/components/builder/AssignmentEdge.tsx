    ...
    <>
      ...
      <EdgeLabelRenderer>
        <div
          ...
          className="group"
        >
          <div className="bg-card/90 backdrop-blur-md border border-indigo-500/20 rounded-full px-4 py-2 flex items-center gap-2 shadow-2xl hover:scale-110 transition-all cursor-pointer hover:border-indigo-500/50">
