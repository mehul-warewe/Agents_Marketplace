    ...
    <header className="h-16 bg-background border-b border-border/60 flex items-center justify-between px-6 shrink-0 z-[60] font-inter">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          />
          {isEmployeeMode && (
            <div className="px-2 py-1 bg-amber-500/10 border border-amber-500/30 rounded-md">
              <span className="text-[9px] font-black uppercase tracking-widest text-amber-600">Employee Mode</span>
            </div>
          )}
        </div>
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        >
          ...
          {isEmployeeMode ? 'Save Employee' : (isEditMode ? 'Update' : 'Deploy')}
        </button>
