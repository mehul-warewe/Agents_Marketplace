      ...
      <div className="max-w-[1400px] mx-auto space-y-12">
        ...
        <header className="space-y-12">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-10">
            <div className="space-y-4">
               <h1 className="text-5xl sm:text-6xl font-black tracking-tighter text-foreground uppercase italic leading-none px-4">Registry Explorer</h1>
               <p className="text-muted font-bold text-lg max-w-xl px-4 opacity-50 uppercase tracking-tight">Discover and deploy high-performance autonomous entities into your private grid.</p>
            </div>
            <button 
            ...
            >
              <Zap size={18} strokeWidth={3} /> Initialise Model
            </button>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
             <div className="lg:col-span-3 relative group">
                ...
                <input 
                  type="text" 
                  placeholder="SEARCH_LOGIC_UNITS // FILTERS..." 
        ...
        {isLoading ? (
          <div className="flex flex-col items-center justify-center py-60">
             ...
             <p className="text-[10px] font-black uppercase tracking-[0.4em] text-muted opacity-40">Polling_Market_Data...</p>
          </div>
          ...
          <div className="flex flex-col items-center justify-center py-40 bg-foreground/[0.02] rounded-[3rem] border border-border/60 border-dashed text-center px-8 relative overflow-hidden">
             ...
             <h3 className="text-3xl font-black mb-4 uppercase tracking-tighter italic">Registry_Void</h3>
              ...
              <div key={agent.id} className="bg-card rounded-[3rem] border border-border/60 p-12 hover:shadow-2xl hover:shadow-foreground/10 hover:border-foreground/20 transition-all duration-500 group flex flex-col relative overflow-hidden">
                ...
                <div className="mb-6 flex items-center gap-3 relative z-10">
                   ...
                   <div className="flex items-center gap-1.5 text-[9px] font-black text-foreground uppercase tracking-[0.2em]">
                     <Shield size={12} strokeWidth={3} /> Verified_Entity
                   </div>
                </div>
                ...
                <div className="mt-auto flex items-center justify-between pt-10 border-t border-border/60 relative z-10">
                  <div className="flex flex-col">
                     ...
                     <span className="text-[8px] font-black text-muted uppercase tracking-[0.3em] mt-1 opacity-40 italic">Unit_Deployment_Cost</span>
                  </div>
                  <button 
